...
- [OWIN](#owin)
- [Авторизация и аутентификация](#авторизация%20и%20аутентификация)
- [Entity Framework notes](#entity%20framework%20notes)
	- [Entity Framework handling concurrency](#entity%20framework%20handling%20concurrency)
		- [Detecting Concurrency Conflicts](#detecting%20concurrency%20conflicts)
	- [Entity Framework handling inheritance](#entity%20framework%20handling%20inheritance)
- [ASP.NET MVC Application Life Cycle](#asp.net%20mvc%20application%20life%20cycle)
- [Security Notes](#security%20notes)
- [Web API](#web%20api)
- [SignalR](#signalr)
