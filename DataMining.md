...
Как уже было сказано выше, системы основанные на пользовательских оценках плохо масштабируются и имеют слишком разряженные матрицы схожести. Поэтому можно использовать классификацию по атрибутам каждого элемента, чтобы найти похожие.
