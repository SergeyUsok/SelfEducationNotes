...
**Architectural Safety Measures** - несколько паттернов, которые автор объеденил под эти термином. Данные паттерны призваны гарантировать что в случае отказа части системы (одного или нескольких сервисов из множества), вся система будет продолжать работать. Автор рекомендует стандартизировать данные паттерны и строго следовать им в разработке.
