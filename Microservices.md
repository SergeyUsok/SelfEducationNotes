...
**Роли авторизации рекумендуется создавать так, чтобы они повторяли структуру предприятия**
